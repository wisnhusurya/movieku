...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_clapperboard.svg
  String get icClapperboard => 'assets/icons/ic_clapperboard.svg';
  ...
  List<String> get values =>
      [icClapperboard, icClose, icHeart, icSearch, icStar];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [imgBackground];
}
